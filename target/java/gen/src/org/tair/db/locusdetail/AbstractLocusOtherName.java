 ...
 */
public abstract class AbstractLocusOtherName extends AbstractDto implements ILocusOtherName {
  ...
  /**
   * Create an empty LocusOtherName for use in building a new object. The 
   * concrete subclass must call this constructor.
   */
  public AbstractLocusOtherName() {
    // Setter arrays
  ...
  /**
   * Create a LocusOtherName. The concrete subclass must call this constructor.
   *
   ...
   */
  public AbstractLocusOtherName(IPrimaryKey key, java.lang.Long locusTairObjectId, java.lang.String name) {
    this.key = key;
  ...
  public boolean equals(Object arg0) {
    AbstractLocusOtherName other = (AbstractLocusOtherName)arg0;
  ...
  public int compareTo(com.poesys.db.dto.IDbDto o) {
    AbstractLocusOtherName other = (AbstractLocusOtherName)o;
