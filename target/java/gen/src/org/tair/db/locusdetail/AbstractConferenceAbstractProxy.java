 ...
 * ConferenceAbstract. This class is an abstract class that contains AndroMDA 
 ...
 */
public abstract class AbstractConferenceAbstractProxy extends AbstractLazyLoadingDtoProxy implements IConferenceAbstract {
  /** Default serial version UID for the Serializable DTO */
  private static final long serialVersionUID = 1L;
  
  /**
   * Create a ConferenceAbstractProxy. The concrete subclass must call this constructor.
   *
   * @param dto the DTO to proxy
   */
  public AbstractConferenceAbstractProxy(ConferenceAbstract dto) {
    super(dto);
  ...
  public boolean equals(Object obj) {
    AbstractConferenceAbstractProxy otherProxy = (AbstractConferenceAbstractProxy)obj;
    return ((ConferenceAbstract)dto).equals(otherProxy.dto);
  }

  @Override
  public int hashCode() {
    return ((ConferenceAbstract)dto).hashCode();
  }
  // Inherited properties

  public java.lang.Long getLocusTairObjectId() {
    return ((IConferenceAbstract)dto).getLocusTairObjectId();
  }

  public java.lang.Long getReferenceTairObjectId() {
    return ((IConferenceAbstract)dto).getReferenceTairObjectId();
  }

  public org.tair.db.locusdetail.ILocusDetail getLocus() {
    return ((IConferenceAbstract)dto).getLocus();
  }
  ...
  private class QueryLociSetter 
    ...
    @Override
    protected IConferenceAbstract getParametersDto() {
      return AbstractConferenceAbstractProxy.this;
    }
    ...
    protected void set(java.util.Collection<org.tair.db.locusdetail.IReferencedLocus> collection) {
      try {
        ...
        for (org.tair.db.locusdetail.IReferencedLocus child : collection) {
          child.attach(AbstractConferenceAbstractProxy.this.dto,
  ...
  public java.util.Collection<org.tair.db.locusdetail.IReferencedLocus> getLoci() throws java.sql.SQLException {
    // Lazy-load the inherited loci from the ConferenceAbstract 
    // if not loaded and the inherited key is not null.
    if (!lociLoaded && ((IConferenceAbstract)dto).getLocusTairObjectId() != null && ((IConferenceAbstract)dto).getReferenceTairObjectId() != null) {
      try {
    ...
    return ((IConferenceAbstract)dto).getLoci();
  }
  ...
  public void clearLoci() {
    ...
    if (lociLoaded) {
      try {
        ...
        ((ConferenceAbstract)dto).setLoci(null);
        ((ConferenceAbstract)dto).undoStatus();
        lociLoaded = false;
      } catch (com.poesys.db.dto.DtoStatusException e) {
  ...
  public void setLoci(java.util.Collection<org.tair.db.locusdetail.IReferencedLocus> loci)
      {
    ((ConferenceAbstract)dto).setLoci(loci);
  ...
  public java.lang.String getTitle() {
    return ((IConferenceAbstract)dto).getTitle();
  }

  public java.lang.String getAuthors() {
    return ((IConferenceAbstract)dto).getAuthors();
  }

  public java.lang.Integer getPublicationYear() {
    return ((IConferenceAbstract)dto).getPublicationYear();
  }

  public java.lang.Integer getLocusCount() {
    return ((IConferenceAbstract)dto).getLocusCount();
  }

  public java.lang.Boolean getAnnotated() {
    return ((IConferenceAbstract)dto).getAnnotated();
  }
  ...
  public java.lang.String getConference() {
    return ((ConferenceAbstract)dto).getConference();
  }

  public void markChildrenDeleted() throws com.poesys.db.dto.DtoStatusException {
  	((ConferenceAbstract)dto).markChildrenDeleted();
  }
}