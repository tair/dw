 ...
 * LocusPolymorphism object through the association Locus using the 
 ...
 */
public abstract class AbstractQueryLocusByLocusPolymorphism 
  ...
  private static final String SQL =
    "SELECT a.locusTairObjectId, a.geneModelName, a.type, a.representative, a.spliceVariant, a.computationalDescription, a.curatedSummary, a.confidence, a.fivePrimeUtrStart, a.fivePrimeUtrEnd, a.fivePrimeUtrId, a.cdsStart, a.cdsEnd, a.cdsId, a.threePrimeUtrStart, a.threePrimeUtrEnd, a.threePrimeUtrId FROM LocusGeneModel a JOIN PolymorphismSite b ON a.geneModelName = b.geneModelName AND a.locusTairObjectId = b.lociLocusTairObjectId WHERE b.polymorphismName = ? AND b.polymorphismsLocusTairObjectId = ?";
