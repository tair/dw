 ...
 * class LocusPolymorphism. These objects are the linking objects from the SQL 
 ...
 */
public abstract class AbstractQueryPolymorphismSiteByLocusPolymorphism 
    implements IParameterizedQuerySql<org.tair.db.locusdetail.IPolymorphismSite, org.tair.db.locusdetail.ILocusPolymorphism> {
  /** SQL query statement for PolymorphismSite */
  private static final String SQL =
    "SELECT lociLocus, lociLocus, locusTairObjectId, polymorphismName, site FROM PolymorphismSite WHERE locusTairObjectId = ? AND polymorphismName = ?";
