 ...
 * CommunityReference. This class is an abstract class that contains AndroMDA 
 ...
 */
public abstract class AbstractCommunityReferenceProxy extends AbstractLazyLoadingDtoProxy implements ICommunityReference {
  ...
  private class QueryMemberSetter 
    ...
    protected com.poesys.db.pk.IPrimaryKey getKey() {
      ...
      // from the org.tair.db.community.ICommunityReference object
      return org.tair.db.community.CommunityFactory.getCommunityPrimaryKey(((ICommunityReference)dto).getCommunityId());
    }
  ...
  /**
   * Create a CommunityReferenceProxy. The concrete subclass must call this constructor.
   *
   * @param dto the DTO to proxy
   */
  public AbstractCommunityReferenceProxy(CommunityReference dto) {
    super(dto);
  ...
  public boolean equals(Object obj) {
    AbstractCommunityReferenceProxy otherProxy = (AbstractCommunityReferenceProxy)obj;
    return ((CommunityReference)dto).equals(otherProxy.dto);
  }

  @Override
  public int hashCode() {
    return ((CommunityReference)dto).hashCode();
  }
  ...
  public java.math.BigInteger getCommunityId() {
    return ((CommunityReference)dto).getCommunityId();
  }

  // Source: AddExplicitSubKeyProperties + addNaturalSubkeyOnClass
  public java.lang.Long getTairObjectId() {
    return ((CommunityReference)dto).getTairObjectId();
  }

  // Source: AddLocalAttributeProperties
  public java.lang.String getTitle() {
    return ((CommunityReference)dto).getTitle();
  }

  // Source: AddLocalAttributeProperties
  public java.lang.String getSource() {
    return ((CommunityReference)dto).getSource();
  }

  // Source: AddLocalAttributeProperties
  public java.lang.Integer getPublicationYear() {
    return ((CommunityReference)dto).getPublicationYear();
  }
  ...
  public org.tair.db.community.ICommunity getMember() throws java.sql.SQLException {
    ...
    if (!memberLoaded && ((ICommunityReference)dto).getCommunityId() != null) {
      try {
    ...
    return ((CommunityReference)dto).getMember();
  }
  ...
  public void clearMember() {
    ...
    if (memberLoaded) {
      try {
        ...
        ((CommunityReference)dto).setMember(null);
        ((CommunityReference)dto).undoStatus();
        memberLoaded = false;
  ...
  void setMember(org.tair.db.community.ICommunity member)
      throws com.poesys.db.InvalidParametersException {
    ((CommunityReference)dto).setMember(member);
  ...
  public void markChildrenDeleted() throws com.poesys.db.dto.DtoStatusException {
  	((CommunityReference)dto).markChildrenDeleted();
  }
}