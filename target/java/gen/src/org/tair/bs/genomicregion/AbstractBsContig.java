...
import org.tair.db.genomicregion.IContig;
import org.tair.db.genomicregion.ContigProxy;
import org.tair.db.genomicregion.Contig;


/**
 * <p>
 * A business layer data-transfer object (DTO) for the Contig. This class
 ...
 */
public abstract class AbstractBsContig 
    extends AbstractDto<org.tair.db.genomicregion.IContig> {
   ...
   */
  public AbstractBsContig(IContig dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a Contig from new data.
   *
...
name (MI421-MI421); may or may not be unique within a genome
   ...
   */
  public AbstractBsContig(IPrimaryKey key, java.lang.Long tairObjectId, java.lang.String name, java.sql.Timestamp dateEntered, java.lang.Long parentRegionTairObjectId, java.lang.String genome, java.lang.String sequence) {
    super(new ContigProxy(new Contig(key, tairObjectId, name, dateEntered, parentRegionTairObjectId, genome, sequence)));
  }
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<IContig> other = (IDto<IContig>)arg0;
  ...
  public int compareTo(IDto<IContig> o) {
...
// Read/Write property: false
   ...
   * <ul>
   * <li>Property is read/write: true</li>
   * <li>Property is defined in the data-access object Contig</li>
   * </ul>
   * </p>
