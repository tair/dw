 ...
 * Community subsystem. This class is abstract and has a single concrete 
 * subclass, CommunityDelegateFactory, that you can modify to override
 ...
 */
public abstract class AbstractCommunityDelegateFactory {
  /** 
   * The fully qualified name of the Community subsystem properties file,
   ...
   * For example, the subsystem community in the org.tair.db 
   * package has the property file org.tair.db.community_en_US.properties
   * for the default locale english (US).
   */
  private static final String PROPERTY_FILE = "org.tair.db.community";
  ...
  /**
   * Get the CommunityDelegate. The file Community.properties supplies the
   ...
   * @return the delegate
   */
  public static CommunityDelegate getCommunityDelegate() {
    return new CommunityDelegate(subsystem);
  }
   ...
   * @return the delegate
   */
  public static CommunityDelegate getJndiCommunityDelegate() {
    return new CommunityDelegate(subsystem, 
                                   com.poesys.db.connection.IConnectionFactory.DBMS.JNDI);
  }
  /**
   * Get the PersonDelegate. The file Community.properties supplies the
   * database subsystem for the delegate to use. The method enables caching and
   * constructs the Delegate with the subsystem from the property file. The
   * database and password are set from the database properties file entries
   * for the subsystem.
   ...
   * @return the delegate
   */
  public static PersonDelegate getPersonDelegate() {
    return new PersonDelegate(subsystem);
  }
   ...
   * @return the delegate
   */
  public static PersonDelegate getJndiPersonDelegate() {
    return new PersonDelegate(subsystem, 
                                   com.poesys.db.connection.IConnectionFactory.DBMS.JNDI);
  }
  /**
   * Get the CountryDelegate. The file Community.properties supplies the
   * database subsystem for the delegate to use. The method enables caching and
   * constructs the Delegate with the subsystem from the property file. The
   * database and password are set from the database properties file entries
   * for the subsystem.
  ...
  /**
   * Get the OrganizationDelegate. The file Community.properties supplies the
   * database subsystem for the delegate to use. The method enables caching and
   * constructs the Delegate with the subsystem from the property file. The
   * database and password are set from the database properties file entries
   * for the subsystem.
   ...
   * @return the delegate
   */
  public static OrganizationDelegate getOrganizationDelegate() {
    return new OrganizationDelegate(subsystem);
  }
   ...
   * @return the delegate
   */
  public static OrganizationDelegate getJndiOrganizationDelegate() {
    return new OrganizationDelegate(subsystem, 
                                   com.poesys.db.connection.IConnectionFactory.DBMS.JNDI);
  }
}