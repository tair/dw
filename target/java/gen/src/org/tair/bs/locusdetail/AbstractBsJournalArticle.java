...
import org.tair.db.locusdetail.IJournalArticle;
import org.tair.db.locusdetail.JournalArticleProxy;
import org.tair.db.locusdetail.JournalArticle;


/**
 * <p>
 * A business layer data-transfer object (DTO) for the JournalArticle. This class
 ...
 */
public abstract class AbstractBsJournalArticle 
    extends AbstractDto<org.tair.db.locusdetail.IJournalArticle> {
   ...
   */
  public AbstractBsJournalArticle(IJournalArticle dto) throws DelegateException {
    super(dto);
  }

  /**
   * Create a JournalArticle from new data.
   *
...
link to the PubMed record
  ...
  public boolean equals(Object arg0) {
    // Unchecked cast here
    IDto<IJournalArticle> other = (IDto<IJournalArticle>)arg0;
  ...
  public int compareTo(IDto<IJournalArticle> o) {
...
// Read/Write property: false
   ...
   * <ul>
   * <li>Property is read/write: false</li>
   * <li>Property is defined in the data-access object JournalArticle</li>
   * </ul>
   * </p>
