...
/**
 * <p>
 * Test the ConferenceAbstractDelegate class.
 * </p>
 * <p>
 ...
 */
public abstract class AbstractConferenceAbstractDelegateTest {
  /** Define a class logger. */
  protected static Logger logger = Logger.getLogger(AbstractConferenceAbstractDelegateTest.class);
  ...
  protected ConferenceAbstractDelegate delegate = null;
  ...
  @Before
  public void setUp() {
    delegate = LocusdetailDelegateFactory.getConferenceAbstractDelegate();
  ...
  protected void clearCaches() {
    // Primary class ConferenceAbstractProxy cache
    IDaoManager manager = DaoManagerFactory.getManager(getSubsystem());
    if (manager != null) {
      manager.clearCache(org.tair.db.locusdetail.ConferenceAbstractProxy.class.getName());
    }
  }

  /**
   * Get a test key for the create method or primary key for a ConferenceAbstract. 
   ...
   * @return ${property.typename} key value
   */
  abstract protected java.lang.Long getTestKeyReferenceTairObjectId(int objectNumber);
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    com.poesys.db.pk.CompositePrimaryKey key = 
      (com.poesys.db.pk.CompositePrimaryKey)org.tair.db.locusdetail.LocusdetailFactory.getConferenceAbstractPrimaryKey(getTestKeyLocusTairObjectId(0), getTestKeyReferenceTairObjectId(0));
    assertTrue("No key generated from concrete implementation", key != null);
    
    // Query the object.
    BsConferenceAbstract object = delegate.getObject(key);
  ...
  public void testGetAllObjects() 
    ...
    List<BsConferenceAbstract> objects = delegate.getAllObjects(100);
   ...
   */
  protected BsConferenceAbstract queryStoredObject(com.poesys.db.pk.CompositePrimaryKey key)
      throws DelegateException {
    // Clear the caches, then query the saved object and test it.
    clearCaches();

    BsConferenceAbstract queriedObject = delegate.getObject(key);
