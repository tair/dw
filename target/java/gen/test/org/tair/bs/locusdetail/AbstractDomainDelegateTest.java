 ...
 */
public abstract class AbstractDomainDelegateTest {
  /** Define a class logger. */
  protected static Logger logger = Logger.getLogger(AbstractDomainDelegateTest.class);
  ...
  protected DomainDelegate delegate = null;
  ...
  @Before
  public void setUp() {
    delegate = LocusdetailDelegateFactory.getDomainDelegate();
  ...
  protected void clearCaches() {
    // Primary class DomainProxy cache
    IDaoManager manager = DaoManagerFactory.getManager(getSubsystem());
    if (manager != null) {
      manager.clearCache(org.tair.db.locusdetail.DomainProxy.class.getName());
    }
  ...
  /**
   * Get a test key for the create method or primary key for a Domain. 
   ...
   */
  abstract protected java.lang.String getTestKeyAccession(int objectNumber);
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    com.poesys.db.pk.NaturalPrimaryKey key = 
      (com.poesys.db.pk.NaturalPrimaryKey)org.tair.db.locusdetail.LocusdetailFactory.getDomainPrimaryKey(getTestKeyAccession(0));
    assertTrue("No key generated from concrete implementation", key != null);
    
    // Query the object.
    BsDomain object = delegate.getObject(key);
    assertTrue("Couldn't get object", object != null);
    
    // Testing lazy loading of model Collection property
    java.util.Collection<org.tair.bs.locusdetail.BsProteinModel> model = 
      object.getModel();
  ...
  public void testGetAllObjects() 
    ...
    List<BsDomain> objects = delegate.getAllObjects(100);
   ...
   */
  protected BsDomain queryStoredObject(com.poesys.db.pk.NaturalPrimaryKey key)
      throws DelegateException {
    // Clear the caches, then query the saved object and test it.
    clearCaches();

    BsDomain queriedObject = delegate.getObject(key);
