...
/**
 * <p>
 * Test the JournalArticleDelegate class.
 * </p>
 * <p>
 ...
 */
public abstract class AbstractJournalArticleDelegateTest {
  /** Define a class logger. */
  protected static Logger logger = Logger.getLogger(AbstractJournalArticleDelegateTest.class);
  ...
  protected JournalArticleDelegate delegate = null;
  ...
  @Before
  public void setUp() {
    delegate = LocusdetailDelegateFactory.getJournalArticleDelegate();
  ...
  protected void clearCaches() {
    // Primary class JournalArticleProxy cache
    IDaoManager manager = DaoManagerFactory.getManager(getSubsystem());
    if (manager != null) {
      manager.clearCache(org.tair.db.locusdetail.JournalArticleProxy.class.getName());
    }
  }

  /**
   * Get a test key for the create method or primary key for a JournalArticle. 
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    com.poesys.db.pk.CompositePrimaryKey key = 
      (com.poesys.db.pk.CompositePrimaryKey)org.tair.db.locusdetail.LocusdetailFactory.getJournalArticlePrimaryKey(getTestKeyLocusTairObjectId(0), getTestKeyReferenceTairObjectId(0));
    assertTrue("No key generated from concrete implementation", key != null);
    
    // Query the object.
    BsJournalArticle object = delegate.getObject(key);
  ...
  public void testGetAllObjects() 
    ...
    List<BsJournalArticle> objects = delegate.getAllObjects(100);
   ...
   */
  protected BsJournalArticle queryStoredObject(com.poesys.db.pk.CompositePrimaryKey key)
      throws DelegateException {
    // Clear the caches, then query the saved object and test it.
    clearCaches();

    BsJournalArticle queriedObject = delegate.getObject(key);
