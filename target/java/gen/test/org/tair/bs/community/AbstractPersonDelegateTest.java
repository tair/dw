 ...
 */
public abstract class AbstractPersonDelegateTest {
  /** Define a class logger. */
  protected static Logger logger = Logger.getLogger(AbstractPersonDelegateTest.class);
  ...
  protected PersonDelegate delegate = null;
  ...
  protected void clearCaches() {
    // Primary class PersonProxy cache
    IDaoManager manager = DaoManagerFactory.getManager(getSubsystem());
    if (manager != null) {
      manager.clearCache(org.tair.db.community.PersonProxy.class.getName());
    }
  ...
  /**
   * Get a test key for the create method or primary key for a Person. 
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    com.poesys.db.pk.SequencePrimaryKey key = 
      (com.poesys.db.pk.SequencePrimaryKey)org.tair.db.community.CommunityFactory.getPersonPrimaryKey(getTestKeyCommunityId(0));
    assertTrue("No key generated from concrete implementation", key != null);
    
    // Query the object.
    BsPerson object = delegate.getObject(key);
    assertTrue("Couldn't get object", object != null);
    
    // Testing lazy loading of organization Collection property
    java.util.Collection<org.tair.bs.community.BsOrganization> organization = 
      object.getOrganization();
    assertTrue("organization not lazily loaded", organization != null);
  ...
  public void testGetAllObjects() 
    ...
    List<BsPerson> objects = delegate.getAllObjects(100);
   ...
   */
  protected BsPerson queryStoredObject(com.poesys.db.pk.SequencePrimaryKey key)
      throws DelegateException {
    // Clear the caches, then query the saved object and test it.
    clearCaches();

    BsPerson queriedObject = delegate.getObject(key);
