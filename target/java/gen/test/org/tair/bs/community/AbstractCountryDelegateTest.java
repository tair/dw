...
public abstract class AbstractCountryDelegateTest {
  ...
  @Before
  public void setUp() {
    delegate = CommunityDelegateFactory.getCountryDelegate();
  ...
  protected void clearCaches() {
    ...
    if (manager != null) {
      manager.clearCache(org.tair.db.community.Country.class.getName());
    }
  }

  /**
   * Get a test key for the create method or primary key for a Country. 
   ...
   */
  abstract protected java.math.BigInteger getTestKeyCountryId(int objectNumber);
  ...
  public void testGetObject() throws java.sql.SQLException {
    ...
    com.poesys.db.pk.SequencePrimaryKey key = 
      (com.poesys.db.pk.SequencePrimaryKey)org.tair.db.community.CommunityFactory.getCountryPrimaryKey(getTestKeyCountryId(0));
